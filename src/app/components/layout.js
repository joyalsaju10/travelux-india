    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-blue-900 text-white p-4 shadow-md">
        <nav className="container mx-auto flex items-center justify-between">
          <h1 className="text-xl font-bold">Travelux India</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center sm:text-left">
            ...
            <div>
              ...
              <p className="text-sm">Phone: +919633111010</p>
      ...
      <div>
        ...
        <p className="text-sm">#4, First floor,Geo Tower, Kavaraparambu Near Cochin International Airport</p>
        <p className="text-sm">Kochi, Kerala, India</p>
            ...
            <div>
              ...
              <div className="flex justify-center sm:justify-start space-x-4">
                <a href="https://www.facebook.com/profile.php?id=61551762601021&mibextid=ZbWKwL" className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-gray-700 transition">
                  <img src="/icons/facebook.svg" alt="Facebook" className="w-5 h-5" />
                </a>
                <a href="https://wa.me/919633111010" className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-gray-700 transition">
                  <img src="/icons/whatsapp.svg" alt="WhatsApp" className="w-5 h-5" />
                </a>
                <a href="https://www.instagram.com/travelux_india_tours?igsh=MWc0b2o3bjNvazJ1Ng==" className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-gray-700 transition">
