...
export default function Captivatingkerala() {
...
<section className="mt-6 bg-blue-100 p-6 rounded-lg shadow-md">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
    ...
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      ...
      <p className="text-black">Alleppey - Cochin</p>
    </div>
  </div>
</section>
 ...
 <section className="mt-6 p-6 bg-white shadow-md rounded-lg">
      ...
      <section className="mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mt-4">
          <Image src="/images/C2.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/C3.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/C4.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/C5.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
        </div>
      </section>
