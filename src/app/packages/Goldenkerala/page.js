...
<section className="mt-6 bg-blue-100 p-6 rounded-lg shadow-md">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
    ...
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      ...
      <p className="text-black">Alleppey - Kovalam</p>
    </div>
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      <span className="bg-yellow-500 text-white px-3 py-1 rounded mr-3 font-bold">D-6</span>
      <p className="text-black">Kovalam - Sightseeing</p>
    </div>
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      <span className="bg-yellow-500 text-white px-3 py-1 rounded mr-3 font-bold">D-7</span>
      <p className="text-black">Kovalam - Trivandrum</p>
    </div>
  </div>
</section>
 ...
 <section className="mt-6 p-6 bg-white shadow-md rounded-lg">
      ...
      <section className="mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mt-4">
          <Image src="/images/G2.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/G3.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/CK2.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/G5.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
        </div>
      </section>
