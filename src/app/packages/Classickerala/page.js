...
export default function classicKerala() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col items-center mt-4">
        <Image src="/images/CK1.jpg" alt="Evergreen Kerala" width={800} height={450} className="rounded-lg shadow-lg" />
...
<section className="mt-6 bg-blue-100 p-6 rounded-lg shadow-md">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
    ...
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      ...
      <p className="text-black">Munnar - Alleppey</p>
    </div>
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
...
<section className="mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mt-4">
          <Image src="/images/G4.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/CK3.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/CK4.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/CK5.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
        </div>
      </section>
