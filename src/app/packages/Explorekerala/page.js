  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col items-center mt-4">
        <Image src="/images/EK1.jpg" alt="Explore Kerala" width={800} height={450} className="rounded-lg shadow-lg" />
        <h1 className="text-3xl font-bold text-center text-blue-600">Explore Kerala</h1>
        <p className="text-lg mt-2 text-gray-700">6 Days | 5 Nights</p>
        <p className="text-center text-gray-600 mt-2">
        Experience Kerala's beauty with our Munnar Thekkady Alleppey Package! Enjoy 6 days of scenic views and cultural shows.        </p>
      </div>
...
<section className="mt-6 bg-blue-100 p-6 rounded-lg shadow-md">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
    ...
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      ...
      <p className="text-black">Munnar - Thekkady</p>
    </div>
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      <span className="bg-yellow-500 text-white px-3 py-1 rounded mr-3 font-bold">D-4</span>
      <p className="text-black">Thekkady - Alleppey</p>
    </div>
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      <span className="bg-yellow-500 text-white px-3 py-1 rounded mr-3 font-bold">D-5</span>
      <p className="text-black">Alleppey - Athirappilly</p>
    </div>
    <div className="flex items-center bg-white p-3 rounded-lg shadow">
      <span className="bg-yellow-500 text-white px-3 py-1 rounded mr-3 font-bold">D-6</span>
      <p className="text-black">Athirappilly - Cochin</p>
    </div>
  </div>
</section>
...
<section className="mt-6 p-6 bg-white shadow-md rounded-lg">
       ...
       <section className="mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mt-4">
          <Image src="/images/EK2.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/EK3.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/EK4.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
          <Image src="/images/EK5.jpg" alt="" width={400} height={250} className="rounded-lg shadow-md" />
        </div>
      </section>
